...
// ----------------------------------------------------------------------------
// --------------------------SEHIFENIN HEADERI---------------------------------------
document.querySelectorAll(".NavbarLeftLi")[2].style.backgroundImage =
  "linear-gradient(to right,#8423D3,#47176D)";
document.querySelectorAll(".NavbarLeftLi")[2].style.color = "white";
document.querySelectorAll(".NavbarLeftLi")[2].style.borderRadius = "3px";
...
navitems[2].style.backgroundColor = "indigo";
navitems[2].style.color = "white";
